...
Meanwhile, I founded [capmake](https://www.arthurlirui.com) that works on blockchain digital arts and develops technologies to make 3D Non-Fungible Token (NFT). I am also interested in designing trading and learning system for high-performance, low-latency, robust trading robots, deploy to cryptocurrency markets (e.g., Binance, Huobi), see [algotech](https://www.arthurlirui.com) for more details.
