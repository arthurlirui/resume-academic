...
Else: I also put much time into high-frequency trading and algorithmic trading by training an AI system with historical data for better decision making and predicting the near-future actions of trading rivals, currently run a very small private equity for fun and earn extra income by myself, mainly in cryptocurrency markets. If you are a daily trader, you will actually meet my trading bots in mainstream markets (but I close them due to market regulation issues recently). Later, I am considering combining blockchain and 3D reconstruction tasks for a photo-realistic NFT as well.
