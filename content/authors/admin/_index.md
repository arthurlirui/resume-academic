...
Research: my academic research interests are using various image measurements (e.g., light field, polarized images, normal RGB images) to solve higher-level inverse problem challenging applications, such as photo-realistic 3D scene reconstruction/representation, viewpoint synthesis, depth estimation, reflection removal via hierarchical representation of neural networks in large-scale data setting. 
